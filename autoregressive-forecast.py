...
# weights_1 = tf.Variable(tf.random_normal((lag*18,1),
...
# flat = tf.reshape(conv0,[-1,lag*18])
...
# print(s.run(predicted_y,feed_dict={input_X:X[:100],input_y:y[:100]}).shape)
f = (conv0.shape[1]*conv0.shape[2])
f.value
